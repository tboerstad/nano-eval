...
- embedding: stsb (semantic textual similarity benchmark)
"""

from tasks.chartqa import chartqa
from tasks.gsm8k import gsm8k_cot_llama
from tasks.stsb import stsb

TASKS = {"text": gsm8k_cot_llama, "vision": chartqa, "embedding": stsb}

__all__ = ["TASKS", "gsm8k_cot_llama", "chartqa", "stsb"]
