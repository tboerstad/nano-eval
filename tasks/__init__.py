...
- embedding: sts_b (semantic textual similarity benchmark)
"""

from tasks.chartqa import chartqa
from tasks.gsm8k import gsm8k_cot_llama
from tasks.sts import sts_b

TASKS = {"text": gsm8k_cot_llama, "vision": chartqa, "embedding": sts_b}

__all__ = ["TASKS", "gsm8k_cot_llama", "chartqa", "sts_b"]
